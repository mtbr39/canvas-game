...
export class Launcher {
    ...
    canvas2d() {
        ...
        animalFactory.make({ number: 10, layers: ["animal"], speciesName: "boidA" });
        animalFactory.make({ number: 3, layers: ["animal"], speciesName: "boidB", shapeColor: "#94E4A9", width: 15, height: 15, velocity: 0.4, });
        animalFactory.make({ number: 2, layers: ["animal"], speciesName: "boidC", shapeColor: "#FF8E87", width: 20, height: 20, velocity: 0.5, });
        animalFactory.make({ number: 3, layers: ["animal"], speciesName: "boidE", shapeColor: "#FFA769", width: 25, height: 25, velocity: 0.3, });
        animalFactory.make({ number: 4, layers: ["animal"], speciesName: "boidE", shapeColor: "#FFA769", width: 10, height: 10, velocity: 0.3, });
